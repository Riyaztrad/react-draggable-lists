...
function reinsert(params) {
    var arr = params.arr, from = params.from, to = params.to;
...
function clamp(params) {
    var n = params.n, min = params.min, max = params.max;
...
var DraggableList = /** @class */ (function (_super) {
    ...
    function DraggableList(props) {
        ...
        _this.handleMouseMove = function (e) {
            var pageX = e.pageX, pageY = e.pageY;
            var _a = _this.state, width = _a.width, height = _a.height, count = _a.count, orders = _a.orders, rowSize = _a.rowSize, lastPress = _a.lastPress, isPressed = _a.isPressed, _b = _a.mouseDelta, dx = _b[0], dy = _b[1];
            if (isPressed) {
    ...
    DraggableList.prototype.render = function () {
        ...
        return (createElement("div", { style: {
            ...
            var x;
            var y;
            var visualPosition = orders.indexOf(key);
            if (key === lastPress && isPressed) {
                ...
                _a = _this.getLayout()[visualPosition], x = _a[0], y = _a[1];
                style = {
            ...
            return (createElement(reactMotion_1, { key: 'elemetn123445' + key, style: style }, function (_a) {
                var translateX = _a.translateX, translateY = _a.translateY, scale = _a.scale;
                return (createElement("div", { onMouseDown: function (e) {
